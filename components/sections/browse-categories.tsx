  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      {/* Square icon tiles, 3-up on phones and 6-up from lg. The icon carries
          ...
          dropped entirely, because categories are database rows — only the six
          slugs above have a glyph and anything else falls back to the car
          icon, so an unlabelled tile would be indistinguishable from its
