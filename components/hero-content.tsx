  ...
  return (
    <section className="relative overflow-hidden px-4 pb-16 pt-14 sm:px-6 lg:px-8">
      ...
      <Image
        ...
        width={320}
        height={320}
        className="pointer-events-none absolute top-1/2 right-[calc(1.5rem+3cm)] hidden size-64 translate-y-[calc(-50%+2cm)] object-contain opacity-90 lg:block dark:hidden xl:right-[calc(4rem+3cm)] xl:size-80"
        priority
      />
      <Image
        ...
        width={320}
        height={320}
        className="pointer-events-none absolute top-1/2 right-[calc(1.5rem+3cm)] hidden size-64 translate-y-[calc(-50%+2cm)] object-contain opacity-90 lg:dark:block xl:right-[calc(4rem+3cm)] xl:size-80"
        priority
      />
